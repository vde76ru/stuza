...
/*
|--------------------------------------------------------------------------
| API Routes для проекта Стужа (ИСПРАВЛЕННАЯ ВЕРСИЯ v2.1)
|--------------------------------------------------------------------------
*/
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // ИСПРАВЛЕНО: Работа с изображениями
        ...
        // ИСПРАВЛЕНО: АТРИБУТЫ (ОБНОВЛЕНО С ПОДДЕРЖКОЙ ЗНАЧЕНИЙ)
        ...
        // ИСПРАВЛЕНО: ОТДЕЛЬНЫЕ МАРШРУТЫ ДЛЯ ЗНАЧЕНИЙ АТРИБУТОВ

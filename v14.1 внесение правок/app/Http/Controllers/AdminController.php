...
class AdminController extends Controller
{
    ...
    {
        // ИСПРАВЛЕНИЕ: Правильная валидация для одного изображения
        $validator = Validator::make($request->all(), [
        ...
        try {
            ...
            // ИСПРАВЛЕНИЕ: Простое сохранение без Intervention Image (пока)
            ...
            // Создание миниатюры (копия основного файла пока)

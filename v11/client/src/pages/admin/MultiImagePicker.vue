        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div class="grid grid-cols-4 gap-3">
            <div 
              ...
              :class="{ 'ring-2 ring-blue-500': tempSelected.includes(image) }"
            >
              <img 
                :src="image" 
                class="w-full h-32 object-cover rounded"
                :class="{ 'opacity-75': tempSelected.includes(image) }"
              >
              <div 
                v-if="tempSelected.includes(image)"
...
const toggleImage = (image) => {
  const index = tempSelected.value.indexOf(image)
  if (index > -1) {
    tempSelected.value.splice(index, 1)
  } else {
    tempSelected.value.push(image)
  }
}

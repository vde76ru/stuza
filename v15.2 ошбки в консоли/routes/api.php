...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('images')->group(function () {
            ...
            Route::delete('/{id}', [AdminController::class, 'deleteImage']); // Изменено с {filename} на {id}
            Route::post('/set-main', [AdminController::class, 'setMainImage']); // НОВЫЙ
            Route::post('/reorder', [AdminController::class, 'reorderImages']); // НОВЫЙ
        });

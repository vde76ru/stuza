...
class AdminController extends Controller
{
    ...
    public function uploadImage(Request $request): JsonResponse
    {
        ...
        try {
            ...
            // Обработка основного изображения с Intervention Image
            ...
            // Оптимизация качества основного изображения
            ...
            $thumbnailImage->fit(300, 300); // Квадратные миниатюры 300x300
            $thumbnailImage->encode($image->getClientOriginalExtension(), 80);
            ...
            $allFiles = collect(Storage::disk('public')->files($folder))
                ...
                ->map(function ($file) use ($folder) {
                    ...
                    $thumbnailUrl = Storage::disk('public')->exists($thumbnailPath) 
                        ...
                        : $url; // Если миниатюры нет, используем основное изображение
    
                    return [
                        'filename' => $filename,
                        'path' => $file,
                        'url' => $url,
                        'thumbnail_url' => $thumbnailUrl, // Новое поле
                        'size' => $size,
